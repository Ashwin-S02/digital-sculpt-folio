...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Jack, an independent 3D creator and designer." },
      { name: "author", content: "Jack" },
      { property: "og:title", content: "Jack -- 3D Creator" },
      { property: "og:description", content: "Portfolio of Jack, an independent 3D creator and designer." },
